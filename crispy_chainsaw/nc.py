...
class ShellListener(threading.Thread):
    def __init__(self, listening_ip, listening_port, buffer=1024, connections=1, timeout=10, verbose=True):
        """
        ...
        self.conn = None  # the socket object usable to send and receive data on the connection
